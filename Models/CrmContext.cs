...
public partial class CrmContext : DbContext
{
    ...
    public virtual DbSet<AlertRate> AlertRates { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;port=3306;database=crm;uid=liantsoa;pwd=liantsoa", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.40-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AlertRate>(entity =>
        {
            entity.HasKey(e => e.AlertRateId).HasName("PRIMARY");

            entity.ToTable("alert_rate");

            entity.Property(e => e.AlertRateId).HasColumnName("alert_rate_id");
        ...
        modelBuilder.Entity<Expense>(entity =>
        {
            ...
            entity.HasIndex(e => e.BudgetId, "budget_id");
        ...
        modelBuilder.Entity<TriggerLead>(entity =>
        {
            ...
            entity.HasOne(d => d.Expense).WithMany(p => p.TriggerLeads)
                .HasForeignKey(d => d.ExpenseId)
                .HasConstraintName("trigger_lead_ibfk_4");
        ...
        modelBuilder.Entity<TriggerTicket>(entity =>
        {
            ...
            entity.HasOne(d => d.Expense).WithMany(p => p.TriggerTickets)
                .HasForeignKey(d => d.ExpenseId)
